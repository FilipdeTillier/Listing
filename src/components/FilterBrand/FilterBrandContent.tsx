...
export const FilterBrandContent: FC<FilterBrandContentProps> = ({
  open,
  close,
  value,
  onReset,
  ...
  const locationLabel = useMemo(
    () => brands.find((el) => el.value === value)?.label,
    [value]
  );
  ...
  return (
    <>
      ...
      >
        <Popover.Panel className="absolute z-10 w-screen max-w-lg px-4 mt-3 left-0 sm:px-0 ">
